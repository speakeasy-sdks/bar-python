...
class Config(BaseSDK):
    def subscribe_to_webhooks(
        ...
        *,
        request: Union[
            List[operations.RequestBody], List[operations.RequestBodyTypedDict]
        ],
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", List[operations.RequestBody]
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="subscribeToWebhooks",
        ...
        if utils.match_response(http_res, "200", "*"):
            return operations.SubscribeToWebhooksResponse(
