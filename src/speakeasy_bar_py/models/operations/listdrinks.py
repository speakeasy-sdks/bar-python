...
import pydantic
from speakeasy_bar_py.models.components import drink as components_drink, drinktype as components_drinktype, error as components_error, httpmetadata as components_httpmetadata
...
class ListDrinksRequest(BaseModel):
    drink_type: Annotated[Optional[components_drinktype.DrinkType], pydantic.Field(alias="drinkType"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
    r"""The type of drink to filter by. If not provided all drinks will be returned."""
