...
import pydantic
from speakeasy_bar_py.models.components import error as components_error, httpmetadata as components_httpmetadata, order as components_order, order_input as components_order_input
...
class CreateOrderRequest(BaseModel):
    request_body: Annotated[List[components_order_input.OrderInput], FieldMetadata(request=RequestMetadata(media_type="application/json"))]
    callback_url: Annotated[Optional[str], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
    r"""The url to call when the order is updated."""
