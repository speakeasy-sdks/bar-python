...
import pydantic
from speakeasy_bar_py.models.components import drink as components_drink, error as components_error, httpmetadata as components_httpmetadata
...
class GetDrinkRequest(BaseModel):
    name: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
