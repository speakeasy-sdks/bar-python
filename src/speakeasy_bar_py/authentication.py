    ...
    def authenticate(
        ...
        *,
        request: Union[
            ...
            operations.AuthenticateRequestBodyTypedDict,
        ],
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", operations.AuthenticateRequestBody
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.AuthenticateResponse(
                object=utils.unmarshal_json(
                    http_res.text, Optional[operations.AuthenticateResponseBody]
                ),
